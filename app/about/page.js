  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            O código de conduta do Camões, I.P. assente nos princípios da
            ...
            isenção e justiça; iv. A qualidade e a produtividade do trabalho, a
            igualdade de oportunidades e de tratamento de pessoas e a
            não-discriminação.
          </p>
          <p>
            Além dos valores fundamentais do Camões, I.P., e no âmbito do
            ensino, a CEPE Alemanha identifica ainda:
          </p>
          <p>
            V. O saber, saber-fazer, saber-estar, saber-ser, saber-aprender vi.
            A abertura e respeito pela identidade e diversidade cultural; vii. A
            cidadania ativa e contribuição para o desenvolvimento pessoal,
            profissional e cultural numa sociedade pluralista;
          </p>
        </div>
      </div>

      <div className="col-span-2">
        <Image src={img_test} alt="image test 3" quality={80} />
      </div>
    </div>
  );
}
